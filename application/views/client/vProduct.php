<section id="produk" class="blog blog-carousel tabs text-center pb-90">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#About" data-toggle="tab"><h4>Our Product</h4></a></li>
				</ul>
                    ...
                    <div class="tab-pane fade banner banner-5" id="History">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
                                <img class="center-block mb-20" src="assets/images/banners/15.png" alt="history">
