...
<!-- Mirrored from demo.zytheme.com/granny/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Dec 2018 15:47:21 GMT -->
<head>
    <!-- Document Meta
    ============================================= -->
    <meta charset="utf-8">
    ...
    <!-- Stylesheets
    ============================================= -->
    <link href="<?php echo base_url()?>master/assets/css/external.css" rel="stylesheet">
    <link href="<?php echo base_url()?>master/assets/css/bootstrap.min.css" rel="stylesheet">
